...
function paginateCategoria(pages){

	cadena=""
	cadena+="<li class='page-item  small'><a class='page-link' onclick=categoria("+1+")>First</a></li>"
	for (let i = 1; i <=pages ; i++) {
		cadena+="<li class='page-item  small'><a class='page-link' onclick=categoria("+i+")>"+i+"</a></li>"		
	}
	cadena+="<li class='page-item  small'><a class='page-link' onclick=categoria("+pages+")>Last</a></li>"
