...
function paginateRoles(pages){

	cadena=""
	cadena+="<li class='page-item  small'><a class='page-link' onclick=roles("+1+")>First</a></li>"
	for (let i = 1; i <=pages ; i++) {
		cadena+="<li class='page-item  small'><a class='page-link' onclick=roles("+i+")>"+i+"</a></li>"		
	}
	cadena+="<li class='page-item  small'><a class='page-link' onclick=roles("+pages+")>Last</a></li>"
