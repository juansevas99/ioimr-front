...
function paginateAtributo(pages){

	cadena=""
	cadena+="<li class='page-item  small'><a class='page-link' onclick=atributo("+1+")>First</a></li>"
	for (let i = 1; i <=pages ; i++) {
		cadena+="<li class='page-item  small'><a class='page-link' onclick=atributo("+i+")>"+i+"</a></li>"		
	}
	cadena+="<li class='page-item  small'><a class='page-link' onclick=atributo("+pages+")>Last</a></li>"
