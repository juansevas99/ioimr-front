...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Administracion /Lista de categoria</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <main id="productos" class="  m-3">
                ...
                <div class="d-block d-lg-flex justify-content-between">
                    ...
                    <div class="form-group">
                        <a href="#">
                            <button class="accordion" type="submit" onclick="CargarContenido('crearCategoria', 'content-wrapper','categoria_crear')">
